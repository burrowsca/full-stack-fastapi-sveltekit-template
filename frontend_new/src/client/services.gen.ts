 ...
 * @throws ApiError
 */
export const readItems = (data: ReadItemsData = {}): CancelablePromise<ReadItemsResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/api/v1/items/',
    query: {
        skip: data.skip,
 ...
 * @throws ApiError
 */
export const createItem = (data: CreateItemData): CancelablePromise<CreateItemResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/api/v1/items/',
    body: data.requestBody,
    mediaType: 'application/json',
 ...
 * @throws ApiError
 */
export const readItem = (data: ReadItemData): CancelablePromise<ReadItemResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/api/v1/items/{id}',
    path: {
        id: data.id
 ...
 * @throws ApiError
 */
export const updateItem = (data: UpdateItemData): CancelablePromise<UpdateItemResponse> => { return __request(OpenAPI, {
    method: 'PUT',
    url: '/api/v1/items/{id}',
    path: {
        id: data.id
 ...
 * @throws ApiError
 */
export const deleteItem = (data: DeleteItemData): CancelablePromise<DeleteItemResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/api/v1/items/{id}',
    path: {
        id: data.id
